  ...
  return (
    <footer className="relative">
      ...
      <div className="md:m-16 container px-4">
        ...
        <div className="md:flex block md:text-left text-center lg:text-left">
            <div>
            ...
            { navdetails.map((data,idx) => (
                <div className="text-gray-500 font-bold m-4 mx-0" key={idx}>
                    { data.title === 'Sharjah' || data.title === 'Dubai' ?
                        <p className="text-black"> { data.title} <p> {data.details} </p> </p>
                    :
          ...
          <div className="w-full lg:w-6/12 px-4">
            <div className="flex items-top mb-6">
              <div className="w-full lg:w-4/12 md:ml-32">
